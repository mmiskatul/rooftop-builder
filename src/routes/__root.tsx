  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <p className="eyebrow">Rooftop Soi3</p>
        <h1 className="mt-4 text-6xl">404</h1>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Rooftop Soi3 — Rooftop Dining in Dhanmondi, Dhaka" },
      {
        name: "description",
        content:
          "Rooftop Soi3 is an open-air rooftop restaurant on Satmasjid Road, Dhanmondi — kebabs, naan, pasta and seafood under the Dhaka skyline.",
      },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "Restaurant",
          name: "Rooftop Soi3",
          servesCuisine: ["Asian Fusion", "Chinese", "Kebab"],
          priceRange: "৳৳",
          url: "http://rooftopsoi3.com/",
          address: {
            "@type": "PostalAddress",
            streetAddress: "R Plaza, Satmasjid Road",
